...
"}")
        ...
        self.label_16 = QtWidgets.QLabel(parent=self.frame_LineEditAlumno)
...
"}")
        ...
        self.frame_Principal_Padre.setMaximumSize(QtCore.QSize(1000, 600))
        ...
        self.frame_LineEditPadre.setMaximumSize(QtCore.QSize(16777215, 200))
        ...
        self.lineEdit_NombreAlumno_2 = QtWidgets.QLineEdit(parent=self.frame_LineEditPadre)
        self.lineEdit_NombreAlumno_2.setMaxLength(50)
        self.lineEdit_NombreAlumno_2.setObjectName("lineEdit_NombreAlumno_2")
        self.verticalLayout_14.addWidget(self.lineEdit_NombreAlumno_2)
        self.lineEdit_ApellidoPalumno_2 = QtWidgets.QLineEdit(parent=self.frame_LineEditPadre)
        self.lineEdit_ApellidoPalumno_2.setObjectName("lineEdit_ApellidoPalumno_2")
        self.verticalLayout_14.addWidget(self.lineEdit_ApellidoPalumno_2)
        self.lineEdit_ApellidoMAlumno_2 = QtWidgets.QLineEdit(parent=self.frame_LineEditPadre)
        self.lineEdit_ApellidoMAlumno_2.setMaxLength(50)
        self.lineEdit_ApellidoMAlumno_2.setObjectName("lineEdit_ApellidoMAlumno_2")
        self.verticalLayout_14.addWidget(self.lineEdit_ApellidoMAlumno_2)
        self.lineEdit_CURPalumno_2 = QtWidgets.QLineEdit(parent=self.frame_LineEditPadre)
        self.lineEdit_CURPalumno_2.setObjectName("lineEdit_CURPalumno_2")
        self.verticalLayout_14.addWidget(self.lineEdit_CURPalumno_2)
        self.lineEdit_ClaveTrabajoAlumno_2 = QtWidgets.QLineEdit(parent=self.frame_LineEditPadre)
        self.lineEdit_ClaveTrabajoAlumno_2.setObjectName("lineEdit_ClaveTrabajoAlumno_2")
        self.verticalLayout_14.addWidget(self.lineEdit_ClaveTrabajoAlumno_2)
        self.formLayout_3.setWidget(0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.frame_LineEditPadre)
        self.label_19 = QtWidgets.QLabel(parent=self.frame_Principal_Padre)
...
"}")
        ...
        self.lineEdit = QtWidgets.QLineEdit(parent=self.frame_Principal_Padre)
        self.lineEdit.setObjectName("lineEdit")
        self.verticalLayout_28.addWidget(self.lineEdit)
        self.lineEdit_3 = QtWidgets.QLineEdit(parent=self.frame_Principal_Padre)
        self.lineEdit_3.setObjectName("lineEdit_3")
        self.verticalLayout_28.addWidget(self.lineEdit_3)
        self.lineEdit_2 = QtWidgets.QLineEdit(parent=self.frame_Principal_Padre)
        self.lineEdit_2.setObjectName("lineEdit_2")
        self.verticalLayout_28.addWidget(self.lineEdit_2)
        self.lineEdit_4 = QtWidgets.QLineEdit(parent=self.frame_Principal_Padre)
        self.lineEdit_4.setObjectName("lineEdit_4")
        self.verticalLayout_28.addWidget(self.lineEdit_4)
        self.formLayout_3.setLayout(2, QtWidgets.QFormLayout.ItemRole.FieldRole, self.verticalLayout_28)
        self.verticalLayout_15 = QtWidgets.QVBoxLayout()
        self.verticalLayout_15.setObjectName("verticalLayout_15")
        self.label_17 = QtWidgets.QLabel(parent=self.frame_Principal_Padre)
        self.label_17.setObjectName("label_17")
        self.verticalLayout_15.addWidget(self.label_17)
        self.label = QtWidgets.QLabel(parent=self.frame_Principal_Padre)
        self.label.setObjectName("label")
        self.verticalLayout_15.addWidget(self.label)
        self.label_18 = QtWidgets.QLabel(parent=self.frame_Principal_Padre)
        self.label_18.setObjectName("label_18")
        self.verticalLayout_15.addWidget(self.label_18)
        self.label_20 = QtWidgets.QLabel(parent=self.frame_Principal_Padre)
        self.label_20.setObjectName("label_20")
        self.verticalLayout_15.addWidget(self.label_20)
        self.formLayout_3.setLayout(2, QtWidgets.QFormLayout.ItemRole.LabelRole, self.verticalLayout_15)
...
"}")
        ...
        self.PushBoton_Insertar_Alumno_2 = QtWidgets.QPushButton(parent=self.frame_18)
        self.PushBoton_Insertar_Alumno_2.setStyleSheet("QPushButton{\n"
"color:black;\n"
"}\n"
"\n"
"QPushButton:hover{\n"
...
"background-color:rgb(80,150,210);\n"
"}")
        self.PushBoton_Insertar_Alumno_2.setObjectName("PushBoton_Insertar_Alumno_2")
        self.horizontalLayout_38.addWidget(self.PushBoton_Insertar_Alumno_2)
        self.PushBoton_Modificar_Alumno_2 = QtWidgets.QPushButton(parent=self.frame_18)
        self.PushBoton_Modificar_Alumno_2.setStyleSheet("QPushButton{\n"
"color:black;\n"
"}\n"
"\n"
"QPushButton:hover{\n"
"border: 1px solid black;\n"
"}")
        self.PushBoton_Modificar_Alumno_2.setObjectName("PushBoton_Modificar_Alumno_2")
        self.horizontalLayout_38.addWidget(self.PushBoton_Modificar_Alumno_2)
        self.PushBoton_Eliminar_Alumno_2 = QtWidgets.QPushButton(parent=self.frame_18)
        self.PushBoton_Eliminar_Alumno_2.setEnabled(True)
        self.PushBoton_Eliminar_Alumno_2.setStyleSheet("QPushButton{\n"
"color:black;\n"
"}\n"
"\n"
"QPushButton:hover{\n"
...
"color:White;\n"
"}")
        self.PushBoton_Eliminar_Alumno_2.setObjectName("PushBoton_Eliminar_Alumno_2")
        self.horizontalLayout_38.addWidget(self.PushBoton_Eliminar_Alumno_2)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_16.setText(_translate("MainWindow", "$ 0000"))
        ...
        self.label_19.setText(_translate("MainWindow", "Datos Fiscales"))
        self.label_17.setText(_translate("MainWindow", "Regimen"))
        self.label.setText(_translate("MainWindow", "Codigo Postal"))
        self.label_18.setText(_translate("MainWindow", "Calle"))
        self.label_20.setText(_translate("MainWindow", "Municipio"))
        self.PushBoton_Insertar_Alumno_2.setText(_translate("MainWindow", "INSERTAR"))
        self.PushBoton_Modificar_Alumno_2.setText(_translate("MainWindow", "MODIFICAR"))
        self.PushBoton_Eliminar_Alumno_2.setText(_translate("MainWindow", "ELIMINAR"))
